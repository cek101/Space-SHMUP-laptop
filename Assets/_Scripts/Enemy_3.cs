...
public class Enemy_3 : Enemy     {
    ...
    // again, start works well becuase it is not used by the Enemy superclass

    void Start () {
        points = new Vector3[3];

        // the start position has laready been set by main.SpawnEnemy()
        points[0] = pos;
    ...
    public override void Move() {
        ...
        Vector3 p01, p12;
        // u = u - 0.2f*Mathf.Sin(u*Mathf.PI * 2); // helps with Bezier curve
